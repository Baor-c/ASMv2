...
namespace FastFoodApp.Migrations
{
    ...
    [Migration("20250805161701_RemoveProductOptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASM1.Models.CartItemSelectedOption", b =>
                {
                    b.Property<int>("CartItemID")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
                    ...
                    b.ToTable("CartItemSelectedOptions");
                });
            ...
            modelBuilder.Entity("ASM1.Models.Option", b =>
                {
                    b.Property<int>("OptionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASM1.Models.OptionGroup", b =>
                {
                    b.Property<int>("OptionGroupID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASM1.Models.ProductOptionMapping", b =>
                {
                    b.Property<int>("ProductID")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
                    ...
                    b.ToTable("ProductOptionMappings");
                });
            ...
            modelBuilder.Entity("ASM1.Models.CartItemSelectedOption", b =>
                {
                    b.HasOne("ASM1.Models.CartItem", "CartItem")
                        .WithMany("SelectedOptions")
                        .HasForeignKey("CartItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASM1.Models.Option", "Option")
                        .WithMany()
            ...
            modelBuilder.Entity("ASM1.Models.Option", b =>
                {
                    b.HasOne("ASM1.Models.OptionGroup", "OptionGroup")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("ASM1.Models.ProductOptionMapping", b =>
                {
                    b.HasOne("ASM1.Models.OptionGroup", "OptionGroup")
                        .WithMany("ProductOptionMappings")
                        .HasForeignKey("OptionGroupID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ASM1.Models.MonAn", b =>
                {
                    b.Navigation("ProductOptionMappings");
                });
